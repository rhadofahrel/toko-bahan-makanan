...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function renderTable(products) {
            ...
            products.forEach(p => {
                html += `
                    <tr>
                        <td>
                            <img src="${p.photo ? '/storage/' + p.photo : 'https://via.placeholder.com/60'}" class="product-thumb" onerror="this.src='https://via.placeholder.com/60'">
                        </td>
        ...
        window.editProduct = (id, name, price, photo) => {
            ...
            imagePreview.src = photo ? '/storage/' + photo : 'https://via.placeholder.com/150';
            productModal.style.display = 'flex';
        };
